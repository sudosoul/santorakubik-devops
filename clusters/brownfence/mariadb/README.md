# Usage
1. Must be connected to VPN and have KUBECONFIG exported
2. Make config changes to values.yaml
3. Deploy changes via
```
helm install mariadb-release ./ -f values.yaml -n mariadb
```
4. Rollback changes via
```
helm rollback -n mariadb
```
